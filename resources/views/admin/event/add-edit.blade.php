...
@section('content')
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if( !$isEdit )
                <form action="{{ route('admin.event.store') }}" method="POST" class="row" enctype="multipart/form-data">
                @else
                <form action="{{ route('admin.event.update', $data->id) }}" method="POST" class="row" enctype="multipart/form-data">
                    @method('PUT')
                @endif
