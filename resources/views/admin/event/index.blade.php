    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('admin.event.create') }}" class="btn btn-success btn-sm">Tambah Data {{ $title }}</a>
            </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('admin.event.destroy', $v->id) }}" method="POST">
                                @method('DELETE')
                                @csrf
                                {{-- <a class="btn btn-primary btn-block btn-sm" href="{{ route('admin.event.show', $v->id) }}">
                                    <i class="fas fa-folder mr-2"></i>View
                                </a> --}}
                                <a class="btn btn-info btn-block btn-sm" href="{{ route('admin.event.edit', $v->id) }}">
