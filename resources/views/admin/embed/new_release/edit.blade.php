...
@section('content')
        ...
        @if( !$isEdit )
        <form action="{{ route('admin.home.new_release.store') }}" method="post" class="card" enctype="multipart/form-data">
        @else
        <form action="{{ route('admin.home.new_release.update', $data->id) }}" method="POST" class="card" enctype="multipart/form-data">
            @method('PUT')
        @endif
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.home.new_release.index') }}" class="btn btn-link">Cancel</a>
