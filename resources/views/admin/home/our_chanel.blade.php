...
@section('content')
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('admin.home.o_update') }}" method="POST" class="row" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="maxResults" value="{{ $data->maxResults }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
