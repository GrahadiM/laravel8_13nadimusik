    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('admin.news.create') }}" class="btn btn-success btn-sm">Tambah Data {{ $title }}</a>
            </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('admin.news.destroy', $v->id) }}" method="POST">
                                @method('DELETE')
                                @csrf
                                {{-- <a class="btn btn-primary btn-block btn-sm" href="{{ route('admin.news.show', $v->id) }}">
                                    <i class="fas fa-folder mr-2"></i>View
                                </a> --}}
                                <a class="btn btn-info btn-block btn-sm" href="{{ route('admin.news.edit', $v->id) }}">
